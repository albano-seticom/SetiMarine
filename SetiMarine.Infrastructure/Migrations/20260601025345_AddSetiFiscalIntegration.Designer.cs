...
namespace SetiMarine.Infrastructure.Migrations
{
    ...
    [Migration("20260601025345_AddSetiFiscalIntegration")]
    partial class AddSetiFiscalIntegration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.AgendamentoUso", b =>
                {
                    ...
                    b.Property<int?>("PlanoContratoServicoId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PlanoContratoServicoId");
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.ConfiguracaoMarina", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("CaixaAutomatico")
                        .HasColumnType("boolean");

                    b.Property<string>("CodigoNbsDefault")
                        .HasColumnType("text");

                    b.Property<string>("CodigoServicoDefault")
                        .HasColumnType("text");

                    b.Property<int>("EmpresaId")
                        .HasColumnType("integer");

                    b.Property<string>("SetiFiscalApiKey")
                        .HasColumnType("text");

                    b.Property<string>("SetiFiscalBaseUrl")
                        .HasColumnType("text");

                    b.Property<Guid?>("SetiFiscalEmpresaId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("cfg_configuracao_marina", (string)null);
                });

            modelBuilder.Entity("SetiMarine.Domain.Entities.ConsumoPlano", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ContratoId", "PlanoContratoServicoId", "Periodo")
                        .IsUnique();

                    b.ToTable("cfg_consumo_plano", (string)null);
                });
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.MovimentoCaixa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("mar_movimentos_caixa", (string)null);
                });

            modelBuilder.Entity("SetiMarine.Domain.Entities.MovimentoEstoque", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("mar_movimentos_estoque", (string)null);
                });

            modelBuilder.Entity("SetiMarine.Domain.Entities.Nota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("mar_notas", (string)null);
                });

            modelBuilder.Entity("SetiMarine.Domain.Entities.NotaItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("mar_nota_itens", (string)null);
                });
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.ProdutoAux", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("mar_produtos_aux", (string)null);
                });
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.Secao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("TipoPreferencial")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("mar_secoes", (string)null);
                });
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.SessaoCaixa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("ValorFechamentoContado")
                        .HasColumnType("numeric");

                    b.Property<decimal?>("ValorFechamentoEsperado")
                        .HasColumnType("numeric");
                    ...
                    b.ToTable("mar_sessoes_caixa", (string)null);
                });
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.AgendamentoUso", b =>
                {
                    ...
                    b.HasOne("SetiMarine.Domain.Entities.Contrato", "Contrato")
                        .WithMany()
                    ...
                    b.HasOne("SetiMarine.Domain.Entities.PlanoContratoServico", "PlanoContratoServicoUsado")
                        .WithMany()
                        .HasForeignKey("PlanoContratoServicoId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("PlanoContratoServicoUsado");
                });
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.ConsumoPlano", b =>
                {
                    ...
                    b.HasOne("SetiMarine.Domain.Entities.PlanoContratoServico", "PlanoContratoServico")
                        .WithMany()
                        .HasForeignKey("PlanoContratoServicoId")
                    ...
                    b.Navigation("PlanoContratoServico");
                });
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.Corredor", b =>
                {
                    ...
                    b.HasOne("SetiMarine.Domain.Entities.Secao", "Secao")
                        .WithMany("Corredores")
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.MovimentoCaixa", b =>
                {
                    ...
                    b.HasOne("SetiMarine.Domain.Entities.SessaoCaixa", "SessaoCaixa")
                        .WithMany("Movimentos")
                        .HasForeignKey("SessaoCaixaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SetiMarine.Domain.Entities.VendaProduto", "VendaProduto")
                        .WithMany()
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.NotaItem", b =>
                {
                    b.HasOne("SetiMarine.Domain.Entities.Nota", "Nota")
                        .WithMany("Itens")
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.ProdutoAux", b =>
                {
                    b.HasOne("SetiMarine.Domain.Entities.Produto", "Produto")
                        .WithOne("Aux")
                        .HasForeignKey("SetiMarine.Domain.Entities.ProdutoAux", "ProdutoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SetiMarine.Domain.Entities.SessaoCaixa", b =>
                {
                    b.HasOne("SetiMarine.Domain.Entities.Usuario", "Operador")
                        .WithMany()
